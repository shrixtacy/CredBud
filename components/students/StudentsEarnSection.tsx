    ...
    <section className="py-20 md:py-24 px-6 md:px-12 bg-bg-secondary border-t-[1.6px] border-ink w-full">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white brutal-card p-8 flex flex-col justify-between">
          ...
          <div className="bg-accent-gold brutal-card p-8 flex flex-col justify-between">
          ...
          <div className="bg-accent-cyan brutal-card p-8 flex flex-col justify-between">
