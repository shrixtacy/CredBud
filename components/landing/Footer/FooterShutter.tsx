...
export const FooterShutter = () => {
  ...
  return (
    <footer ref={footerRef} className="h-screen w-full bg-bg-secondary flex flex-col relative z-20 shadow-[0_-20px_50px_rgba(0,0,0,0.1)]">
      
      {/* Top Nav */}
      <div className="flex flex-col md:flex-row justify-between p-12 w-full max-w-7xl mx-auto">
