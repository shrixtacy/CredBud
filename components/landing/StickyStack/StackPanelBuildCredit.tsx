...
export const StackPanelBuildCredit = () => {
  ...
  return (
    <div className="sticky top-[5vh] md:top-[4vh] h-[90vh] md:h-[92vh] w-full z-[13] flex items-center justify-center my-4">
      <div ref={containerRef} className="w-[95%] md:w-[96%] h-full bg-bg-primary flex items-center p-8 brutal-card bg-elements overflow-hidden">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <h2 className="font-bricolage text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.05]">
              Start building your <br />
              <KeywordHighlight text="credit score" /> early.
            </h2>
            <p className="font-jakarta text-lg text-ink-muted max-w-md">
          ...
          <div className="h-[400px] flex items-end justify-center space-x-4 md:space-x-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center h-full justify-end w-16 md:w-24">
                <span className="font-bricolage font-extrabold text-xl md:text-3xl text-ink/30 mb-4">{item.score}</span>
                ...
                <span className="font-jetbrains text-xs text-ink-muted mt-4">{item.label}</span>
              </div>
            ))}
          </div>
